...
//Then we look at the next number, 3. Similarly, all multiples of 3 such as 3 ¡Á 2 = 6, 3 ¡Á 3 = 9, ... must not be primes, so we mark them off as well. 
...
//So we can skip 4 immediately and go to the next number, 5. Now, all multiples of 5 such as 5 ¡Á 2 = 10, 5 ¡Á 3 = 15, 5 ¡Á 4 = 20, 5 ¡Á 5 = 25, ... can be marked off. 
//There is a slight optimization here, we do not need to start from 5 ¡Á 2 = 10. Where should we start marking off?
//
//In fact, we can mark off multiples of 5 starting at 5 ¡Á 5 = 25, because 5 ¡Á 2 = 10 was already marked off by multiple of 2, similarly 5 ¡Á 3 = 15 was already marked off by multiple of 3. 
