...
Google, Amazon, Indeed, Intuit, Karat, Roblox, Pinterest
*/
...
public:
    ...
    // 10%
    void SplitString(const string& str, unordered_map<string, int>& m) {
        vector<string> ans;
        
        size_t pos = str.find(" ");
        int cnt = stoi(str.substr(0, pos));
        
        ans.push_back(str.substr(pos+1));
        pos = pos+1;
