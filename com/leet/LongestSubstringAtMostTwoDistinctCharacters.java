...
public class LongestSubstringAtMostTwoDistinctCharacters {
    ...
    public int lengthOfLongestSubstringTwoDistinct(String s) {
        ...
        int firstPos1 = -1, lastPos1 = -1, firstPos2 = -1, lastPos2 = -1;  //First/last position of first/second letter
        ...
        for (i = 1; i < n; i++) {        	
        	...
        	} else if (carr[i] != letter1 && carr[i] != letter2) {  //Key part
        ...
        if (firstPos2 == -1) nMaxLen = n;  //In case only one kind of character in string
